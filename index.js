...
class ServicoCalculoFatura {
  ...
  calcularTotalApresentacao(pecas, apre) {
    ...
    case "comedia":
      ...
      break;
    default:
      throw new Error(`Peca desconhecia: ${getPeca(pecas, apre).tipo}`);
    }
    return total;
  }
...
function gerarFaturaStr(fatura, pecas, calc) {
  ...
  faturaStr += `Creditos acumulados: ${calc.calcularTotalCreditos(pecas, fatura.apresentacoes)} \n`;
  return faturaStr;
}
...
function gerarFaturaHTML(fatura, pecas) {
  ...
  faturaHTML += `<p> Creditos acumulados: ${calcularTotalCreditos(pecas, fatura.apresentacoes)} </p>\n`;
  faturaHTML += `</html>`;
  return faturaHTML;
  */
}
